...
def briefs(path=None):
    """Load a briefs JSON (default <game>/face_briefs.json); 'use' = inherit."""
    global _BRIEFS
    if _BRIEFS is None or path:
        raw = json.load(open(path or os.path.join(HERE, "face_briefs.json")))
        out = {}
