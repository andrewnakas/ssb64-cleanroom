"""Render N64 decomp geometry (Vtx/Gfx arrays in the decomp's C source) with our generated
...
lists) and the clean tree's generated PNGs; no retail pixels.
    ...
    python -m cleanroom.gfx.c_render <clean tree> <level> <out.png> [--cam eye_x,eye_y,eye_z,at_x,at_y,at_z,fov]
"""
import glob
import math
import os
